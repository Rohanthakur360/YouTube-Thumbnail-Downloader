...
Bot = Client(
    ...
    bot_token = os.environ.get("6506670316:AAFUdXCzyl38pB80o3D0RIfP2CCiZ2S2rfg"),
    api_id = int(os.environ.get("29400566")),
    api_hash = os.environ.get("8fd30dc496aea7c14cf675f59b74ec6f")
)
